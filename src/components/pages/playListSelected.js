...
export default class SelectedPlaylist extends Component {
  ...
  },
  {
    ...
    return (
      <div style={{ background: "#292934", paddingTop: "3%" }} className="container">
        <Row>
          <h1
            style={{
              color: "red",
        ...
        <Row gutter={12} style={{ paddingRight: "3%", paddingLeft: "5%" }}>
          {artistList.map((playList, id) => (
            ...
            >
              ...
              >
                <Card hoverable style={{ width: "100%" }} key={id}>
                  <img className="img" alt="example" src={playList.image} />
                  <Meta style={{ paddingTop: "8%" }} title={playList.name} />
                </Card>
              </Link>
            </Col>
          ))}
